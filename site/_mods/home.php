  ...
  case 'style1':
    ...
    */
    ...
    $main->div('homeTemplateIntro',''); 
      $main->hx(2,$home_row['mod_home_content_IntroTitle'],'','');$main->_hx(2);           
    ...
    $main->div('homeTemplateCols','yui-g');
      $main->div('homeTemplateCol1','yui-u first');
        $main->hx(3,$home_row['mod_home_content_Col1Title'],'','');$main->_hx(3);
        $main->add($home_row['mod_home_content_Col1Text']);
  	  $main->_div();
      $main->div('homeTemplateCol2','yui-u');
        $main->hx(3,$home_row['mod_home_content_Col2Title'],'','');$main->_hx(3);
  ...
  case 'style2':
    ...
    */
    ...
    $main->div('homeTemplateFeature',''); 
      $main->hx(2,$home_row['mod_home_content_FeatureTitle'],'','');$main->_hx(2);           
    ...
    */
    ...
    $main->div('homeTemplateCols','yui-gb');
      ...
      $main->div('homeTemplateCol3','yui-u');
        $main->hx(3,$home_row['mod_home_content_Col3Title'],'','');$main->_hx(3);
...
$main->div('homeTemplateLinks','');
  $main->hx(4,$home_row['mod_home_content_ExploreSite'],'','');$main->_hx(4);
  // Three Columns
