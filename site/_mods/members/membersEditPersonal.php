...
$main->tr('', '');
$main->td('', 'title', '', '');
$main->add('<label for="firstNames">First Names:</label>');
$main->_td();
$main->td('', '', '', '');
...
$main->tr('', '');
$main->td('', 'title', '', '');
$main->add('<label for="state">County/State:</label>');
$main->_td();
$main->td('', '', '', '');
...
$main->tr('', '');
$main->td('', 'title', '', '');
$main->add('<label for="address2">Post Code/Zip:</label>');
$main->_td();
$main->td('', '', '', '');
...
$main->tr('', '');
$main->td('', 'title', '', '');
$main->add('<label for="title">Telphone:</label>');
$main->_td();
$main->td('', '', '', '');
...
$main->tr('', '');
$main->td('', '', '', '');
$main->add('I DO NOT consent for my details being passed on to other members of the Society for purposes of palaeontological research:');
$main->_td();
$main->td('', '', '', '');
