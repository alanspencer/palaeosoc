...
if (isset($_POST['submitApplication'])) {
  ...
  $BCC = '';
  $FROM = '';
  emailMailer(31, $TO, $CC, $BCC, $FROM, $VAR_ARRAY, $db);
  ...
  $BCC = '';
  $FROM = '';
  emailMailer(32, $TO, $CC, $BCC, $FROM, $VAR_ARRAY, $db);
...
$js->script('js','','
  $(document).ready(function(){
    $("#membersRenewInstitiutionForm").validate();
  });
');
...
$main->_div();
$main->hx(2,'Members\' - Renew as an Institutional Member','','');$main->_hx(2);
$main->div ('membersJoinInstitutionPage','');
  $main->add('<p>To submit an application to the society to renew an instituational membership please fill in the form below.</p>
  ...
  if ($UPDATED) {
    ...
    // Form
    $main->form('?membership=institution','post','','membersRenewInstitiutionForm','');
