...
$main->tr('', '');
$main->td('', '', '', '2');
$main->add('<em>The username must be an e-mail address. This is where all e-mails will be sent.</em>');
$main->_td();
$main->_tr();
$main->tr('', '');
$main->td('', 'title', '', '');
$main->add('Current Username:');
$main->_td();
$main->td('', '', '', '');
...
$main->tr('', '');
$main->td('', 'title', '', '');
$main->add('<label for="username1">New Username:</label>');
$main->_td();
$main->td('', '', '', '');
...
$main->tr('', '');
$main->td('', 'title', '', '');
$main->add('<label for="username2">Re-type New Username:</label>');
$main->_td();
$main->td('', '', '', '');
