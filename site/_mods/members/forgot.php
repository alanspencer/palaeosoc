...
// Username
$main->hx(4, 'Recover Password', '', '');
$main->_hx(4);
$main->table('', 'membersTable');
$main->tbody('', '');
$main->tr('', '');
$main->td('', '', '', '2');
$main->add('Please enter your PalaeoSoc Members Username (this is in the form of an email address).');
$main->_td();
$main->_tr();
$main->tr('', '');
$main->td('', 'title', '', '');
$main->add('<label for="username">Username:</label>');
$main->_td();
$main->td('', '', '', '');
